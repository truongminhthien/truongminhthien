(function ($) {
	...
	var initialFirstPrice = parseInt($('input[name="first_price"]').val().replace(/\D/g, ''));
	var initialLastPrice = parseInt($('input[name="last_price"]').val().replace(/\D/g, ''));

	$("#slider-range").slider({
		range: true,
		min: 1000000,
		max: 15000000,
		values: [initialFirstPrice, initialLastPrice],
	...
	function updateValues(value1, value2) {
		$("#amount").val("VNĐ " + value1.toLocaleString('en-US') + " - " + "VNĐ " + value2.toLocaleString('en-US'));
		$('input[name="first_price"]').val(value1.toLocaleString('en-US') + 'VNĐ ');
		$('input[name="last_price"]').val(value2.toLocaleString('en-US') + 'VNĐ ');
	}

	// Initial values update
	updateValues(initialFirstPrice, initialLastPrice);
